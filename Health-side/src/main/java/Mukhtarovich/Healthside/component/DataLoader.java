package Mukhtarovich.Healthside.component;

import Mukhtarovich.Healthside.Enity.Enums.RoleName;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (init.equals("create-drop") || init.equals("create")) {
            ...
            User doctor = authRepository.save(
                    new User(
                            "Qozi", "gaday", "123456789", passwordEncoder.encode("123456789"), Collections.singleton(roleRepository.findById(2).orElseThrow(() -> new ResourceNotFoundException("getRole"))), true, true, true, true
                    )
            );
        }
    }
